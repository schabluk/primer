...
const Main = () => (
  <div className="ui grid">
    <div className="four wide column">
      <a className="big ui teal button" href="https://forums.meteor.com/t/meteor-1-3-early-beta-now-available/14723" target="_blank" style={{width: '100%'}}>
        <i className="fa fa-cube fa-flip-horizontal fa-2x pull-left"></i> Meteor<br /> 1.3 (Beta)
      </a>
      <div className="ui divider"></div>
      <a className="big ui teal button" href="https://facebook.github.io/react/" target="_blank" style={{width: '100%'}}>
        <i className="fa fa fa-code fa-flip-horizontal fa-2x pull-left"></i> React<br /> 0.14.7
      </a>
      <div className="ui divider"></div>
      <a className="big ui teal button" href="http://v4-alpha.getbootstrap.com/" target="_blank" style={{width: '100%'}}>
        <i className="fa fa-twitter fa-flip-horizontal fa-2x pull-left"></i> Semantic UI<br /> 2.1.8
      </a>
      <div className="ui divider"></div>
      <a className="big ui teal button" href="http://fortawesome.github.io/Font-Awesome/" target="_blank" style={{width: '100%'}}>
    ...
    <div className="twelve wide column">
      <div className="ui card" style={{width: '100%'}}>
        <div className="content">
          <div className="header">ES6 featured Boilerplate for Meteor/React application.</div>
          <div className="description">This is a simple application build upon React, Meteor 1.3 (Beta preview with ES6 features) and Semantic UI.</div>
        </div>
        <div className="ui equal width grid content">
          <div className="column">
            ...
            <ul>
              ...
              <li><a href="https://atmospherejs.com/semantic" target="_blank">semantic ui</a>: development framework that helps create beautiful, responsive layouts using human-friendly HTML.</li>
